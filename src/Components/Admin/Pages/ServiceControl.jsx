...
const ServiceControl = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const url = `https://api.imgbb.com/1/upload?key=${import.meta.env.VITE_APP_SECRET_IMG_API_KEY
            }`;
    ...
    return (
        <>
            ...
            <div
                className={`flex flex-wrap justify-center lg:justify-start px-5 gap-5 ${isModalOpen || addModal && "blur-sm"
                    } animation`}
            >
